...
func (s *Server) Routes() http.Handler {
	...
	api.HandleFunc("GET /nodes/{id}/conn-log", s.wrap("nodes.connlog", v("viewer", s.nodeConnLog)))
	api.HandleFunc("PUT /nodes/{id}/services", s.wrap("nodes.services.set", v("operator", s.setNodeServices)))
	...
	api.HandleFunc("GET /services/search", s.wrap("services.search", v("viewer", s.searchServices)))
